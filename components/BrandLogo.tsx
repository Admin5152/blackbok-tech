...
function LogoSamsung() {
  return (
    <svg viewBox="0 0 64 40" className={svgBase} aria-hidden fill="currentColor">
      <ellipse cx="32" cy="20" rx="30" ry="11" fill="none" stroke="currentColor" strokeWidth="2.5" />
      <ellipse cx="32" cy="20" rx="18" ry="6.5" fill="none" stroke="currentColor" strokeWidth="2" opacity="0.85" />
    </svg>
  );
}
