...
function LogoSamsung() {
  return (
    <svg viewBox="0 0 120 24" className={svgBase} aria-hidden fill="currentColor">
      <path d="M4.2 19.2V4.8h4.1c2.9 0 4.8 1.5 4.8 3.9 0 1.6-.9 2.9-2.4 3.5l3.1 6.9h-2.9l-2.8-6.2H6.4v6.2H4.2zm2.2-8h1.8c1.5 0 2.4-.8 2.4-2.1s-.9-2.1-2.4-2.1H6.4v4.2zM18.6 19.2l-3.4-14.4h2.4l2.2 9.8 2.3-9.8h2.2l2.3 9.8 2.2-9.8h2.3L29.6 19.2h-2.5l-2.4-10.1-2.4 10.1h-2.4zM35.8 19.2V4.8h7.4v1.9h-5.2v4.5h4.6v1.9h-4.6v4.2h5.4v1.9h-7.6zM46.2 19.2V4.8h4c3.4 0 5.6 2.1 5.6 5.3v3.8c0 3.2-2.2 5.3-5.6 5.3h-4zm2.2-1.9h1.7c2.2 0 3.5-1.3 3.5-3.5V10c0-2.2-1.3-3.5-3.5-3.5h-1.7v11.8zM59.2 19.2V4.8h4.1c2.9 0 4.8 1.5 4.8 3.9 0 1.6-.9 2.9-2.4 3.5l3.1 6.9h-2.9l-2.8-6.2h-2.1v6.2H59.2zm2.2-8h1.8c1.5 0 2.4-.8 2.4-2.1s-.9-2.1-2.4-2.1h-1.8v4.2zM73.4 19.2l-1.6-14.4h2.2l1.1 10.5 2.8-10.5h2l2.8 10.5 1.1-10.5h2.2l-1.6 14.4h-2.6l-2.9-10.4-2.9 10.4h-2.6zM89.8 19.4c-3.4 0-5.6-2.4-5.6-6.1V10c0-3.7 2.2-6.1 5.6-6.1s5.6 2.4 5.6 6.1v3.3c0 3.7-2.2 6.1-5.6 6.1zm0-1.9c2.1 0 3.3-1.5 3.3-4.2V10c0-2.7-1.2-4.2-3.3-4.2s-3.3 1.5-3.3 4.2v3.3c0 2.7 1.2 4.2 3.3 4.2zM99.2 19.2V4.8h2.2v14.4h-2.2zM104.2 19.2V4.8h2.2l5.4 9.6V4.8h2.1v14.4h-2.1l-5.5-9.7v9.7h-2.1z" />
    </svg>
  );
}
