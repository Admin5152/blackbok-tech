-- ============================================================
-- Section 21: repair_requests — broaden admin RLS so catalog
-- staff and user_roles-based admins can list/update all rows.
--
-- Replaces the policy from 2026_05_repair_requests.sql that only
-- matched profiles.role = 'admin' (missed staff + JWT admins
-- whose role lives only in user_roles).
--
