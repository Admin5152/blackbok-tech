-- =============================================================================
-- Restore exclusive aesthetic modes (percent / fixed / per_model)
-- Migration: 20260813000600_restore_aesthetic_mode_strict.sql
--
-- 2026_07_trade_estimate_topup_fix.sql reintroduced COALESCE(override, %) which
-- ignored aesthetic_*_mode=per_model exclusivity from 2026_07_aesthetic_mode_strict.
-- Keep deduct_quarter + D16 threshold behaviour; restore exclusive A1/A2 modes.
...
COMMENT ON FUNCTION public.compute_trade_estimate IS
  'Live trade estimate: base − one deduction per component. Aesthetic modes exclusive (percent/fixed/per_model). Battery: ≥91 none · 85–90 25% · 70–84 50% · <70 full.';
