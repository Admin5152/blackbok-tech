...
export const TRADE_COPY = {
  ...
  questionnaire: {
    ...
    liveDeductions: 'Condition adjustments',
    liveTopUpHint: 'Upgrade price minus your trade-in credit after condition adjustments.',
  ...
  summary: {
    ...
    baseValue: 'Starting trade-in value',
    deductions: 'Condition adjustments',
